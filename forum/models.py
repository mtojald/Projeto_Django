...
class Pergunta(models.Model):
    ...
    data_criacao = models.DateTimeField("Criada em ")
    ...
    def string_detalhada(self):
        return "titulo: " + self.titulo + "; detalhe: " + self.detalhe + "; tentativa: " + self.tentativa + "; data criação: " + str(self.data_criacao) + "; usuario: " + self.usuario
